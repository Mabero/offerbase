-- Extend match_offers_contextual to return both offer_id and affiliate link_id
-- This lets the frontend emit stable link_id in analytics events so
-- offer_metrics_daily can attribute clicks/impressions reliably by ID.
